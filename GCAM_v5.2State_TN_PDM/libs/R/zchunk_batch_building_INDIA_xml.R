...
module_gcamindia_batch_building_India_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c("L244.india_state_DeleteConsumer_bld", #done
             ...
             "L244.india_state_SubsectorShrwt_bld", #done
    ...
    L244.india_state_SubsectorShrwt_bld <- get_data(all_data, "L244.india_state_SubsectorShrwt_bld")
   ...
   # ===================================================
    ...
    create_xml("building_india.xml") %>%
      ...
      add_xml_data(L244.india_state_SubsectorShrwt_bld, "SubsectorShrwt") %>%
