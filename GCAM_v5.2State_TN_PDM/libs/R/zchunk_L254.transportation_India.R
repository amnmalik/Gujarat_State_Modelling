...
module_india_L254.transportation <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L154.out_mpkm_india_trn_nonmotor_Yh <- get_data(all_data, "L154.out_mpkm_india_trn_nonmotor_Yh")
    ...
    process_India_restructure(L254.StubTech_passthru) -> L254.StubTranTech_passthru_India
    ...
    L254.StubTranTechProd_nonmotor_India %>%
      ...
      add_precursors("L154.out_mpkm_india_trn_nonmotor_Yh",
