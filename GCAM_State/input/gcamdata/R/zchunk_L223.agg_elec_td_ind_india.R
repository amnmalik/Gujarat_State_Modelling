#' module_gcamindia_L223.agg_elect_td_ind
#'
...
#' the generated outputs: \code{L223.india_state_Supplysector_agg_elect_td_ind}, \code{L223.india_state_SubsectorLogit_agg_elect_td_ind}, \code{L223.india_state_SubsectorShrwtFllt_agg_elect_td_ind},
#' \code{L223.india_state_TechShrwt_agg_elect_td_ind}, \code{L223.india_state_TechCoeff_agg_elect_td_ind},
...
#' @author AM Nov20
module_gcamindia_L223.agg_elect_td_ind <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "gcam-india/A23.india_state_sector_agg_elect_td_ind",
             FILE = "gcam-india/A23.india_state_subsector_logit_agg_elect_td_ind",
             FILE = "gcam-india/A23.india_state_subsector_shrwt_agg_elect_td_ind",
             FILE = "gcam-india/A23.india_state_tech_shrwt_agg_elect_td_ind"))
    ...
    A23.india_state_sector_agg_elect_td_ind <- get_data(all_data, "gcam-india/A23.india_state_sector_agg_elect_td_ind")
    A23.india_state_subsector_logit_agg_elect_td_ind <- get_data(all_data, "gcam-india/A23.india_state_subsector_logit_agg_elect_td_ind")
    A23.india_state_subsector_shrwt_agg_elect_td_ind <- get_data(all_data, "gcam-india/A23.india_state_subsector_shrwt_agg_elect_td_ind")
    A23.india_state_tech_shrwt_agg_elect_td_ind <- get_data(all_data, "gcam-india/A23.india_state_tech_shrwt_agg_elect_td_ind")

    # ===================================================

    A23.india_state_sector_agg_elect_td_ind <- A23.india_state_sector_agg_elect_td_ind %>% mutate(region = "India")
    A23.india_state_subsector_logit_agg_elect_td_ind <- A23.india_state_subsector_logit_agg_elect_td_ind %>% mutate(region = "India")
    A23.india_state_subsector_shrwt_agg_elect_td_ind <- A23.india_state_subsector_shrwt_agg_elect_td_ind %>% mutate(region = "India")
    A23.india_state_tech_shrwt_agg_elect_td_ind <- A23.india_state_tech_shrwt_agg_elect_td_ind %>% mutate(region = "India")


    # convert to long form


    A23.india_state_tech_shrwt_agg_elect_td_ind <- A23.india_state_tech_shrwt_agg_elect_td_ind %>%
      gather_years




    # The agg_elect_td_ind_india_processing function is used in place of a for loop in the old data sytem.
    # This function checks to see if the input data needs to be expanded to all states or used as
    # is.

    # agg_elect_td_ind_india_processing: is a function that
    agg_elect_td_ind_india_processing <- function(data) {
    ...
    A23.india_state_sector_agg_elect_td_ind <- agg_elect_td_ind_india_processing(A23.india_state_sector_agg_elect_td_ind)
    A23.india_state_subsector_logit_agg_elect_td_ind <- agg_elect_td_ind_india_processing(A23.india_state_subsector_logit_agg_elect_td_ind)
    A23.india_state_subsector_shrwt_agg_elect_td_ind <- agg_elect_td_ind_india_processing(A23.india_state_subsector_shrwt_agg_elect_td_ind)
    A23.india_state_tech_shrwt_agg_elect_td_ind <- agg_elect_td_ind_india_processing(A23.india_state_tech_shrwt_agg_elect_td_ind)


    L223.india_state_Supplysector_agg_elect_td_ind <- A23.india_state_sector_agg_elect_td_ind %>%
    ...
    L223.india_state_SubsectorLogit_agg_elect_td_ind <- A23.india_state_subsector_logit_agg_elect_td_ind %>%
    ...
    L223.india_state_SubsectorShrwtFllt_agg_elect_td_ind <- A23.india_state_subsector_shrwt_agg_elect_td_ind %>%
    ...
    L223.india_state_TechShrwt_agg_elect_td_ind <- A23.india_state_tech_shrwt_agg_elect_td_ind %>%
    ...
    L223.india_state_TechCoeff_agg_elect_td_ind <- A23.india_state_tech_shrwt_agg_elect_td_ind %>%
      # Expand table to include all model base and future years
      complete(year = c(year, MODEL_YEARS), nesting(supplysector, subsector, technology,region)) %>%
    ...
    L223.india_state_Supplysector_agg_elect_td_ind %>%
      ...
      add_legacy_name("L223.india_state_Supplysector_agg_elect_td_ind") %>%
      add_precursors("gcam-india/A23.india_state_sector_agg_elect_td_ind") ->
      L223.india_state_Supplysector_agg_elect_td_ind
    ...
    L223.india_state_SubsectorLogit_agg_elect_td_ind %>%
      ...
      add_legacy_name("L223.india_state_SubsectorLogit_agg_elect_td_ind") %>%
      add_precursors("gcam-india/A23.india_state_subsector_logit_agg_elect_td_ind") ->
      L223.india_state_SubsectorLogit_agg_elect_td_ind
    ...
    L223.india_state_SubsectorShrwtFllt_agg_elect_td_ind %>%
      ...
      add_units("Unitless") %>%
      add_comments("Supply subsector information for agg_elec was written for all regions") %>%
      add_legacy_name("L223.india_state_SubsectorShrwtFllt_agg_elect_td_ind") %>%
      add_precursors("gcam-india/A23.india_state_subsector_shrwt_agg_elect_td_ind") ->
      L223.india_state_SubsectorShrwtFllt_agg_elect_td_ind
    ...
    L223.india_state_TechShrwt_agg_elect_td_ind %>%
      ...
      add_units("Unitless") %>%
      add_comments("Supply subsector information for agg_elec was written for all regions") %>%
      add_legacy_name("L223.india_state_TechShrwt_agg_elect_td_ind") %>%
      add_precursors("gcam-india/A23.india_state_tech_shrwt_agg_elect_td_ind") ->
      L223.india_state_TechShrwt_agg_elect_td_ind
    ...
    L223.india_state_TechCoeff_agg_elect_td_ind %>%
      ...
      add_units("Unitless") %>%
      add_comments("Supply subsector information for agg_elec was written for all regions") %>%
      add_legacy_name("L223.india_state_TechCoeff_agg_elect_td_ind") %>%
      add_precursors("gcam-india/A23.india_state_tech_shrwt_agg_elect_td_ind") ->
      L223.india_state_TechCoeff_agg_elect_td_ind


    return_data(L223.india_state_Supplysector_agg_elect_td_ind,
                L223.india_state_SubsectorLogit_agg_elect_td_ind,
                L223.india_state_SubsectorShrwtFllt_agg_elect_td_ind,
                L223.india_state_TechShrwt_agg_elect_td_ind,
                L223.india_state_TechCoeff_agg_elect_td_ind)
