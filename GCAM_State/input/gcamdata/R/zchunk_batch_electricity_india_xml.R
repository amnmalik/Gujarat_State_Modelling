...
module_gcamindia_batch_electricity_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L223.india_state_StubTechFixOut_geothermal <- get_data(all_data, "L223.india_state_StubTechFixOut_geothermal")
    ...
    create_xml("electricity_india.xml") %>%
      ...
      add_xml_data(L223.india_state_StubTechFixOut_geothermal, "StubTechFixOut") %>%
