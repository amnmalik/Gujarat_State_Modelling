...
module_gcamindia_batch_industry_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L232.India_state_GlobalTechEff_ind <- get_data(all_data, "L232.India_state_GlobalTechEff_ind")
    L232.India_state_GlobalTechCoef_ind <- get_data(all_data, "L232.India_state_GlobalTechCoef_ind")
    L232.India_state_GlobalTechCost_ind <- get_data(all_data, "L232.India_state_GlobalTechCost_ind")
    L232.India_state_GlobalTechShrwt_ind <- get_data(all_data, "L232.India_state_GlobalTechShrwt_ind")
    L232.India_state_GlobalTechCSeq_ind <- get_data(all_data, "L232.India_state_GlobalTechCSeq_ind")
    L232.India_state_GlobalTechSecOut_ind <- get_data(all_data, "L232.India_state_GlobalTechSecOut_ind")
    ...
    create_xml("industry_india.xml") %>%
      ...
      add_xml_data(L232.India_state_GlobalTechEff_ind, "GlobalTechEff") %>%
      add_xml_data(L232.India_state_GlobalTechCoef_ind, "GlobalTechCoef") %>%
      add_xml_data(L232.India_state_GlobalTechCost_ind, "GlobalTechCost") %>%
      add_xml_data(L232.India_state_GlobalTechShrwt_ind, "GlobalTechShrwt") %>%
      add_xml_data(L232.India_state_GlobalTechCSeq_ind, "GlobalTechCSeq") %>%
      add_xml_data(L232.India_state_GlobalTechSecOut_ind, "GlobalTechSecOut") %>%
