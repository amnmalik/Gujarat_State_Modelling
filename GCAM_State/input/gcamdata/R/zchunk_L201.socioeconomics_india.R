...
module_gcamindia_L201.socioeconomics <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "gcam-india/india_states_subregions",
             FILE = "gcam-india/A00.india_state_laborforce",
    ...
    A00.india_state_laborforce <- get_data(all_data, "gcam-india/A00.india_state_laborforce")
    ...
    L201.LaborForceFillout <- A00.india_state_laborforce %>% mutate(region = region)
    ...
    L201.LaborForceFillout %>%
      ...
      add_precursors("gcam-india/india_states_subregions",
                     "gcam-india/A00.india_state_laborforce") ->
      L201.LaborForceFillout_GCAMINDIA
